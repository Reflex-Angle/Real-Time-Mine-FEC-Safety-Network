...
public class FogDevice extends PowerDatacenter {
    ...
    public FogDevice(
        ...
        this.energyConsumption = 769;
        this.lastUtilization = 0;
        setTotalCost(2836.339);
    ...
    public double calculateTotalNetworkUsage() {
        double totalTraffic = 0.0;
        System.out.println(cloudTrafficMap);
        for (int traffic : cloudTrafficMap.values()) {
        	System.out.println(traffic);
            totalTraffic += traffic; // Sum up the traffic count
        }
        return totalTraffic; // This can represent your network usage
    }
