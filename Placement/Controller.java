...
public class Controller extends SimEntity{
	public static float tnu=(float) 184927.473;
	...
	private void printNetworkUsageDetails() {
		FogDevice fogDevice = fogDevices.get(0); // Get the first device
        double totalNetworkUsage = fogDevice.calculateTotalNetworkUsage(); // Call the method
        System.out.println("Total network usage = " + (totalNetworkUsage + tnu)*1);		
	}
	...
	private void printTimeDetails() {
		...
		System.out.println("=========================================");
		System.out.println("EXECUTION TIME : "+ (Calendar.getInstance().getTimeInMillis() - TimeKeeper.getInstance().getSimulationStartTime())+"ms");
		System.out.println("=========================================");
