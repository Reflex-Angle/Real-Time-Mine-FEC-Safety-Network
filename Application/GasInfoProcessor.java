...
public class GasInfoProcessor {
    ...
    public GasInfoProcessor(double threshold, int responseModuleId, String appId, int userId) {
    ...
    public boolean processGasReading(double gasReading,int responseModuleId) {
        boolean b=gasReading > threshold;
        if(b) {
        	sendAlert(responseModuleId);
        	System.out.println("GAS: "+gasReading);
        }
        return b;
    }

    public void sendAlert(int sourceDeviceId) {
        System.out.println("ALERT: Gas level exceeded threshold! Sending alert to response module.");
        ...
        alertTuple.setTupleType("gasAlert");            // Unique tuple type
