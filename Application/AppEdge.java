...
public class AppEdge {
	...
	public AppEdge(String source, String destination,double delay, double tupleCpuLength, 
	...
	public AppEdge(String source, String destination,double delay, double periodicity, double tupleCpuLength, 
			double tupleNwLength, String tupleType, int direction, int edgeType){
		setSource(source);
		setDestination(destination);
		setDelay(delay);
