...
public class ChemicalInfoProcessor {
	public class java {
    ...
    public ChemicalInfoProcessor(double threshold, int responseModuleId, String appId, int userId) {
    ...
    public boolean processChemReading(double ChemReading,int responseModuleId) {
        boolean b=ChemReading > threshold;
        if(b) {
        	sendAlert(responseModuleId);
        	System.out.println("CH: "+ChemReading);
        }
        return b;
    }

    public void sendAlert(int sourceDeviceId) {
        System.out.println("ALERT: Radiation level exceeded threshold! Sending alert to response module.");
        ...
        alertTuple.setTupleType("ChemAlert");            // Unique tuple type
